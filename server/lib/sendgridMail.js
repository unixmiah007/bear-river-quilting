...
/**
 * @param {{ to: string, from: string | { email: string, name?: string }, cc?: string | string[], subject: string, text: string, html: string, attachments?: Array<{ content: string, filename: string, type?: string, disposition?: string }> }} opts
 */
